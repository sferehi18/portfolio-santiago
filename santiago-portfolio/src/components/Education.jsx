...
export default function Education() {
  ...
  useReveal(); // 👈 IMPORTANTE: activa el observer

  return (
    <section id="formacion" className="reveal py-24 md:py-32 mb-16">
      ...
      <div className="space-y-12">
        ...
        <div className="reveal flex flex-col md:flex-row justify-between items-start gap-2">
          <div>
